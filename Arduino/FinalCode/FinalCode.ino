...
void setup() {
  ...
  motor.P_angle.P = 12;
  motor.P_angle.I = 20;
  motor.P_angle.D = 0.0125;
  motor.P_angle.output_ramp = 1750;
...
void loop() {
  ...
  if ((millis() - timer > 15)) {
    ...
    if (abs(encoder2.getVelocity()) < 1) {
      ...
      // Serial.print("Enc_dif:"); Serial.println(enc_dif_pitch);
      ...
      Serial.print("ROLL:"); Serial.print(mpu.getAngleX());Serial.println("");
